...
import com.avsp.pro.m7.capture.camera.analyzer.ExposureState
import com.avsp.pro.m7.capture.camera.analyzer.FocusState
import com.avsp.pro.m7.capture.camera.analyzer.ShotAnalysisResult
...
import com.avsp.pro.m7.capture.camera.candidate.CandidateRanker
import com.avsp.pro.m7.capture.camera.candidate.DefaultCandidateRanker
import com.avsp.pro.m7.capture.camera.candidate.DefaultShotCandidateGenerator
import com.avsp.pro.m7.capture.camera.candidate.ShotCandidateGenerator
import com.avsp.pro.m7.capture.camera.candidate.ShotMemory
import com.avsp.pro.m7.capture.camera.engine.CinematographerDecision
import com.avsp.pro.m7.capture.camera.engine.CinematographerDecisionEngine
import com.avsp.pro.m7.capture.camera.engine.DefaultCinematographerDecisionEngine
import com.avsp.pro.m7.capture.camera.planner.LocalShotPlanner
import com.avsp.pro.m7.capture.camera.planner.ShotPlanner
import com.avsp.pro.m7.capture.camera.mission.DefaultShotMissionGenerator
import com.avsp.pro.m7.capture.camera.mission.ShotMission
import com.avsp.pro.m7.capture.camera.mission.ShotMissionItem
import com.avsp.pro.m7.capture.camera.mission.ShotMissionGenerator
import com.avsp.pro.m7.capture.camera.mission.ShotStatus
import com.avsp.pro.m7.capture.camera.mission.ShotMediaType
...
import com.avsp.pro.m7.capture.camera.model.CameraControlMode
...
import com.avsp.pro.m7.capture.camera.understanding.DefaultSceneUnderstandingEngine
import com.avsp.pro.m7.capture.camera.understanding.DefaultSubjectUnderstandingEngine
import com.avsp.pro.m7.capture.camera.understanding.SceneUnderstandingEngine
import com.avsp.pro.m7.capture.camera.understanding.SceneUnderstandingResult
import com.avsp.pro.m7.capture.camera.understanding.SubjectUnderstandingEngine
import com.avsp.pro.m7.capture.camera.understanding.SubjectUnderstandingResult
import com.avsp.pro.m7.capture.camera.vision.DefaultVisualAnalyzer
import com.avsp.pro.m7.capture.camera.vision.VisualAnalysisResult
import com.avsp.pro.m7.capture.camera.vision.VisualAnalyzer
...
class CameraViewModel(
        ...
        if (id.isNotBlank() && projectRepository != null) {
            viewModelScope.launch {
                when (val result = projectRepository.getProjectById(id)) {
                    is com.avsp.pro.m7.core.common.Resource.Success -> {
    ...
    fun loadMasterShotPlan(plan: com.avsp.pro.m7.capture.camera.planner.MasterShotPlan) {
        val mission = com.avsp.pro.m7.capture.camera.planner.ShotMissionPlanAdapter.toShotMission(plan)
    ...
    fun keepPendingMedia(onCompleted: () -> Unit) {
        ...
        viewModelScope.launch {
            ...
            if (currentShot != null) {
                val candidatePlaceholder = com.avsp.pro.m7.capture.camera.candidate.ShotCandidate(
                    id = currentShot.id,
