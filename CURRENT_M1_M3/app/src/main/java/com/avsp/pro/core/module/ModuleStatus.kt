 ...
 * M3 reports [READY] only after implementation is verified.
 */
...
/**
 * Canonical AVSP module identifiers (M1–M9).
 * Frozen modules are listed for status display only — their source is not modified by later modules.
 */
object AvspModules {
