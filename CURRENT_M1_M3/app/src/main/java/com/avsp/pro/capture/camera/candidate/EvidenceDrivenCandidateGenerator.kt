package com.avsp.pro.capture.camera.candidate
        ...
        if (cleanContext != null && (detectedObjects.isNotEmpty() || visibleLabels.isNotEmpty())) {
            ...
            candidates.add(
                ShotCandidate(
                    ...
                    framingFeasibility = if (visualAnalysis.stabilityState == com.avsp.pro.capture.camera.analyzer.StabilityState.STABLE) 0.95f else 0.55f,
                    accessibility = 1.0f,
            ...
            fun addSubjectCandidate(
                ...
                candidates.add(
                    ShotCandidate(
                        ...
                        framingFeasibility = if (isCentered && visualAnalysis.stabilityState == com.avsp.pro.capture.camera.analyzer.StabilityState.STABLE) 0.9f else 0.6f,
                        accessibility = 1.0f,
